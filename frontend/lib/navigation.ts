...
export const reportDefinitions: Record<string, ReportDefinition> = {
  ...
  "ou-management": {
    ...
    description: "Track organizational unit activity, structural churn, and delegated administrative scope through captured AD change events.",
    capability: "activity",
  },
  "gpo-management": {
    key: "gpo-management",
  ...
  "gpo-setting-changes": {
    ...
    category: "Policy Control",
    description: "Review policy-setting modifications and GPO change activity already captured from the AD event plane.",
    capability: "activity",
  },
  "other-ad-object-changes": {
    ...
    category: "Directory Structure",
    description: "Catch residual directory changes that do not fit standard user, computer, group, OU, GPO, or DNS categories.",
    capability: "activity",
  },
  "permission-changes": {
    ...
    description: "Expose permission-oriented modifications and delegated access changes already recorded in the activity stream.",
    capability: "activity",
  },
